...
// returns the full path of the file 'fileName' in the resources directory of the app bundle
...
// load the vertex and fragment shader, and links them to make the global gProgram
...
// load a triangle into the VAO global
...
static void Render() {
    ...
    // swap the display buffers (display what was just drawn)
    glfwSwapBuffers();
}
